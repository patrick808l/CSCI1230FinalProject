...
private:
    ...
    void setupMesh()
    {
        ...
        std::cout << "buffer vbo data, vertices.size() = " << vertices.size() << std::endl;
        glBufferData(GL_ARRAY_BUFFER, vertices.size() * sizeof(Vertex), &vertices[0], GL_STATIC_DRAW);

        glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);
        std::cout << "buffer ebo data, indices.size() = " << indices.size() << std::endl;
        ...
        glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex), reinterpret_cast<void*>(6 * sizeof(GLfloat)));
